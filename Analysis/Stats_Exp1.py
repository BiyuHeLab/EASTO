...
@File    :   Stats_Exp1.py
@Time    :   2025/07/30
@Author  :   Yuan-hao Wu, Brandon Chen 
@Version :   1.0
@Contact :   yuanhao.wu@nyulangone.org, bc1693@nyu.edu
@License :   None
@Desc    :   None

This code create source data for stats and figures corresponding to EASTO Exp 1 results. 
...
# %% EXTRACT THE CATEGORY OF NONTARGETS 
...
# COMPUTE CATEGORIZATION RESPONSE BASED ON NONTARGET CATEGORIES
...
# Remove the trials where the category of target and nontarget were identical 
...
# Generate a list of all possible conditions
...
# %%
# COMPUTE STATS FOR SDT BEHAVIORAL MEASURES (STATS CORRESPONDING TO FIG 2A)
print("***********************************************************************")
...
for i in ['Hit', 'FA', 'd', 'c']:
    ...
    print("")
    print('MARGINAL MEANS BY FACTOR LEVEL')
    print('--------------------------')
    print("")
    print('ATTENDED')
    ...
    print('--------------------------')  
    print("2x2 REPEATED-MEASURES ANOVA")
    print('--------------------------')  
...
#bhv_vars_df.to_pickle(join(DataDir, "Exp1_SDT.pkl"))
...
#accuracy_df.to_pickle(join(DataDir, "Exp1_Categorization.pkl"))

#%% CONFIDENCE BY HIT, FA, MISS, and CR (Fig 2C)
print("")
print("***********************************************************************")
...
#conf_df.to_pickle(join(DataDir, "Exp1_Confidence.pkl"))

#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# RECOGNITION RATE BY NON-TARGET STIMULUS IDENTITY (Fig 3A)
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
print("")
print("***********************************************************************")
...
#rec_df.to_pickle(join(DataDir, "Exp1_Recognition_by_NonTarget.pkl"))
# %% CATEGORIZATION ACCURACY BY NON-TARGET STIMULUS IDENTITY (Fig 3B)
print("")
print("***********************************************************************")
print("***********************************************************************")
