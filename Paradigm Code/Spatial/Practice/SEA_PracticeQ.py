...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/brandonchen93/EASTO/Paradigm/Master/Spatial/Practice/SEA_PracticeQ.py',
...
_rec_resp_allKeys = []
# keep track of which components have finished
q_rec_exempComponents = [q_recognition_3, probe_cue_rec_2, rec_resp]
