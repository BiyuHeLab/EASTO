...
def generate_stim(real_images, scrambled_images, conditions, probability_ratio, paradigm): 
    ...
    if paradigm == 'Spatial':
        ...
        expect_high_trials = {'left_stims' : deepcopy(high_probability_blocks),
                              'right_stims' : deepcopy(high_probability_blocks)}
        
        expect_low_trials = {'left_stims' : deepcopy(low_probability_blocks),
                             'right_stims' : deepcopy(low_probability_blocks)}
        
        return expect_left_trials, expect_right_trials, expect_neutral_trials, expect_high_trials, expect_low_trials
