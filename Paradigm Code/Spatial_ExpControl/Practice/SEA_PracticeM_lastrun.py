...
expInfo = {'subject': '', 'session': '001', 'HPColor': 'black', 'Control': False, 'feedback': False}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/brandonchen93/EASTO/Paradigm/Behavior/Spatial_ExpControl/Practice/SEA_PracticeM_lastrun.py',
...
# Initialize components for Routine "feedback_instr"
feedback_instrClock = core.Clock()
mon = monitors.Monitor('EEG') 
incor_lw = deg2pix(0.4, mon)

feedback_text = ''
fbck_cor_2 = visual.ShapeStim(
    win=win, name='fbck_cor_2', vertices='cross',
    size=(0.4, 0.4),
    ori=0, pos=(0, 0),
    lineWidth=1, lineColor=[-.75,.75,-.75], lineColorSpace='rgb',
    fillColor=[-.75,.75,-.75], fillColorSpace='rgb',
    opacity=.7, depth=-1.0, interpolate=True)
fbck_incor_2 = visual.ShapeStim(
    win=win, name='fbck_incor_2', vertices='cross',
    size=(0.4, 0.4),
    ori=0, pos=(0, 0),
    lineWidth=1, lineColor=[.75,-.75,-.75], lineColorSpace='rgb',
    fillColor=[.75,-.75,-.75], fillColorSpace='rgb',
    opacity=0.7, depth=-2.0, interpolate=True)
feedback_txt_example = visual.TextStim(win=win, name='feedback_txt_example',
    text='default text',
    font='Courier New',
    units='norm', pos=(0, 0), height=0.07, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
...
trial_conditions = 'practice_cond.xlsx'
expect_left_trials, expect_right_trials, expect_neutral_trials, expect_high_trials, expect_low_trials = ea.generate_stim(real_imgs, scram_imgs, trial_conditions, [2/3, 1/3], 'Spatial')
...
post_stim_fix = visual.ShapeStim(
    ...
    fillColor=[-1,-1,-1], fillColorSpace='rgb',
    opacity=0.7, depth=0.0, interpolate=True)
place_left_7 = visual.Rect(
    win=win, name='place_left_7',
    width=(4.2, 4.2)[0], height=(4.2, 4.2)[1],
    ori=0, pos=(-4, 0),
    lineWidth=3, lineColor=1.0, lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
    opacity=0.7, depth=-1.0, interpolate=True)
place_right_7 = visual.Rect(
    win=win, name='place_right_7',
    width=(4.2, 4.2)[0], height=(4.2, 4.2)[1],
    ori=0, pos=(4, 0),
    lineWidth=3, lineColor=1.0, lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
    opacity=0.7, depth=-2.0, interpolate=True)
long_back_R_7 = visual.Rect(
    win=win, name='long_back_R_7',
    width=(4.8, 3.2)[0], height=(4.8, 3.2)[1],
    ori=0, pos=(4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-3.0, interpolate=True)
hi_back_R_7 = visual.Rect(
    win=win, name='hi_back_R_7',
    width=(3.2, 4.8)[0], height=(3.2, 4.8)[1],
    ori=0, pos=(4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-4.0, interpolate=True)
hi_back_L_7 = visual.Rect(
    win=win, name='hi_back_L_7',
    width=(3.2, 4.8)[0], height=(3.2, 4.8)[1],
    ori=0, pos=(-4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-5.0, interpolate=True)
long_back_L_7 = visual.Rect(
    win=win, name='long_back_L_7',
    width=(4.8, 3.2)[0], height=(4.8, 3.2)[1],
    ori=0, pos=(-4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
...
probe_cue_cat = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-3.0)
place_left_8 = visual.Rect(
    win=win, name='place_left_8',
    width=(4.2, 4.2)[0], height=(4.2, 4.2)[1],
    ori=0, pos=(-4, 0),
    lineWidth=3, lineColor=1.0, lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
    opacity=0.7, depth=-4.0, interpolate=True)
place_right_8 = visual.Rect(
    win=win, name='place_right_8',
    width=(4.2, 4.2)[0], height=(4.2, 4.2)[1],
    ori=0, pos=(4, 0),
    lineWidth=3, lineColor=1.0, lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
    opacity=0.7, depth=-5.0, interpolate=True)
long_back_R_8 = visual.Rect(
    win=win, name='long_back_R_8',
    width=(4.8, 3.2)[0], height=(4.8, 3.2)[1],
    ori=0, pos=(4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-6.0, interpolate=True)
hi_back_R_8 = visual.Rect(
    win=win, name='hi_back_R_8',
    width=(3.2, 4.8)[0], height=(3.2, 4.8)[1],
    ori=0, pos=(4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-7.0, interpolate=True)
hi_back_L_8 = visual.Rect(
    win=win, name='hi_back_L_8',
    width=(3.2, 4.8)[0], height=(3.2, 4.8)[1],
    ori=0, pos=(-4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-8.0, interpolate=True)
long_back_L_8 = visual.Rect(
    win=win, name='long_back_L_8',
    width=(4.8, 3.2)[0], height=(4.8, 3.2)[1],
    ori=0, pos=(-4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
...
probe_cue_rec = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-3.0)
place_left_9 = visual.Rect(
    win=win, name='place_left_9',
    width=(4.2, 4.2)[0], height=(4.2, 4.2)[1],
    ori=0, pos=(-4, 0),
    lineWidth=3, lineColor=1.0, lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
    opacity=0.7, depth=-4.0, interpolate=True)
place_right_9 = visual.Rect(
    win=win, name='place_right_9',
    width=(4.2, 4.2)[0], height=(4.2, 4.2)[1],
    ori=0, pos=(4, 0),
    lineWidth=3, lineColor=1.0, lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
    opacity=0.7, depth=-5.0, interpolate=True)
long_back_R_9 = visual.Rect(
    win=win, name='long_back_R_9',
    width=(4.8, 3.2)[0], height=(4.8, 3.2)[1],
    ori=0, pos=(4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-6.0, interpolate=True)
hi_back_R_9 = visual.Rect(
    win=win, name='hi_back_R_9',
    width=(3.2, 4.8)[0], height=(3.2, 4.8)[1],
    ori=0, pos=(4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-7.0, interpolate=True)
hi_back_L_9 = visual.Rect(
    win=win, name='hi_back_L_9',
    width=(3.2, 4.8)[0], height=(3.2, 4.8)[1],
    ori=0, pos=(-4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-8.0, interpolate=True)
long_back_L_9 = visual.Rect(
    win=win, name='long_back_L_9',
    width=(4.8, 3.2)[0], height=(4.8, 3.2)[1],
    ori=0, pos=(-4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
...
probe_cue_cat_2 = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-3.0)
place_left_10 = visual.Rect(
    win=win, name='place_left_10',
    width=(4.2, 4.2)[0], height=(4.2, 4.2)[1],
    ori=0, pos=(-4, 0),
    lineWidth=3, lineColor=1.0, lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
    opacity=0.7, depth=-4.0, interpolate=True)
place_right_10 = visual.Rect(
    win=win, name='place_right_10',
    width=(4.2, 4.2)[0], height=(4.2, 4.2)[1],
    ori=0, pos=(4, 0),
    lineWidth=3, lineColor=1.0, lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
    opacity=0.7, depth=-5.0, interpolate=True)
long_back_R_10 = visual.Rect(
    win=win, name='long_back_R_10',
    width=(4.8, 3.2)[0], height=(4.8, 3.2)[1],
    ori=0, pos=(4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-6.0, interpolate=True)
hi_back_R_10 = visual.Rect(
    win=win, name='hi_back_R_10',
    width=(3.2, 4.8)[0], height=(3.2, 4.8)[1],
    ori=0, pos=(4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-7.0, interpolate=True)
hi_back_L_10 = visual.Rect(
    win=win, name='hi_back_L_10',
    width=(3.2, 4.8)[0], height=(3.2, 4.8)[1],
    ori=0, pos=(-4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
    opacity=1, depth=-8.0, interpolate=True)
long_back_L_10 = visual.Rect(
    win=win, name='long_back_L_10',
    width=(4.8, 3.2)[0], height=(4.8, 3.2)[1],
    ori=0, pos=(-4, 0),
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
...
fbck_cor = visual.ShapeStim(
    ...
    fillColor=[-.75,.75,-.75], fillColorSpace='rgb',
    opacity=.7, depth=-1.0, interpolate=True)
fbck_incor = visual.ShapeStim(
    win=win, name='fbck_incor', vertices='cross',
    size=(0.4, 0.4),
    ori=0, pos=(0, 0),
    lineWidth=1, lineColor=[.75,-.75,-.75], lineColorSpace='rgb',
    fillColor=[.75,-.75,-.75], fillColorSpace='rgb',
...
for thisExp_exemp in exp_exemps:
    ...
    exp_instr_txt = ('''At the beginning of a block you will first see cues that indicate how likely an image with real content will appear within the placeholder. 
    \n\n\n\n\n\n\n
    The {H_color} lined placeholder indicates that a real image is MORE LIKELY to appear within the placeholder. The {L_color} lined placeholders indicates that a real image is LESS LIKELY to appear within the placeholder. 
    If the placeholder is gray, both real and noise images are equaly likely to appear.
    \n
...
# set up handler to look after randomisation of conditions etc
fbck_instr_loop = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('fbck_exemp.xlsx'),
    seed=None, name='fbck_instr_loop')
thisExp.addLoop(fbck_instr_loop)  # add the loop to the experiment
thisFbck_instr_loop = fbck_instr_loop.trialList[0]  # so we can initialise stimuli with some values
# abbreviate parameter names if possible (e.g. rgb = thisFbck_instr_loop.rgb)
if thisFbck_instr_loop != None:
    for paramName in thisFbck_instr_loop:
        exec('{} = thisFbck_instr_loop[paramName]'.format(paramName))

for thisFbck_instr_loop in fbck_instr_loop:
    currentLoop = fbck_instr_loop
    # abbreviate parameter names if possible (e.g. rgb = thisFbck_instr_loop.rgb)
    if thisFbck_instr_loop != None:
        for paramName in thisFbck_instr_loop:
            exec('{} = thisFbck_instr_loop[paramName]'.format(paramName))
    
    # ------Prepare to start Routine "feedback_instr"-------
    continueRoutine = True
    # update component parameters for each repeat
    if expInfo['feedback']:
        if corDetect:
            fbck_cor_2.opacity = 0.7
            fbck_incor_2.opacity = 0
            feedback_text = "\n\n\n Correctly identified image as Real or Noise" 
        else: 
            fbck_cor_2.opacity = 0
            fbck_incor_2.opacity = 0.7
            feedback_text  = "\n\n\n Incorrectly identified image as Real or Noise" 
    else: 
        continueRoutine = False
        
        
        
    feedback_txt_example.setText(feedback_text)
    feedback_instruction.keys = []
    feedback_instruction.rt = []
    _feedback_instruction_allKeys = []
    # keep track of which components have finished
    feedback_instrComponents = [fbck_cor_2, fbck_incor_2, feedback_txt_example, feedback_instruction]
    for thisComponent in feedback_instrComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    feedback_instrClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "feedback_instr"-------
    while continueRoutine:
        # get current time
        t = feedback_instrClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=feedback_instrClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *fbck_cor_2* updates
        if fbck_cor_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            fbck_cor_2.frameNStart = frameN  # exact frame index
            fbck_cor_2.tStart = t  # local t and not account for scr refresh
            fbck_cor_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(fbck_cor_2, 'tStartRefresh')  # time at next scr refresh
            fbck_cor_2.setAutoDraw(True)
        
        # *fbck_incor_2* updates
        if fbck_incor_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            fbck_incor_2.frameNStart = frameN  # exact frame index
            fbck_incor_2.tStart = t  # local t and not account for scr refresh
            fbck_incor_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(fbck_incor_2, 'tStartRefresh')  # time at next scr refresh
            fbck_incor_2.setAutoDraw(True)
        
        # *feedback_txt_example* updates
        if feedback_txt_example.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            feedback_txt_example.frameNStart = frameN  # exact frame index
            feedback_txt_example.tStart = t  # local t and not account for scr refresh
            feedback_txt_example.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(feedback_txt_example, 'tStartRefresh')  # time at next scr refresh
            feedback_txt_example.setAutoDraw(True)
        
        # *feedback_instruction* updates
        waitOnFlip = False
        if feedback_instruction.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            feedback_instruction.frameNStart = frameN  # exact frame index
            feedback_instruction.tStart = t  # local t and not account for scr refresh
            feedback_instruction.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(feedback_instruction, 'tStartRefresh')  # time at next scr refresh
            feedback_instruction.status = STARTED
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(feedback_instruction.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(feedback_instruction.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if feedback_instruction.status == STARTED and not waitOnFlip:
            theseKeys = feedback_instruction.getKeys(keyList=None, waitRelease=False)
            _feedback_instruction_allKeys.extend(theseKeys)
            if len(_feedback_instruction_allKeys):
                feedback_instruction.keys = _feedback_instruction_allKeys[-1].name  # just the last key pressed
                feedback_instruction.rt = _feedback_instruction_allKeys[-1].rt
                # a response ends the routine
                continueRoutine = False
    ...
    # -------Ending Routine "feedback_instr"-------
    for thisComponent in feedback_instrComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    fbck_instr_loop.addData('fbck_cor_2.started', fbck_cor_2.tStartRefresh)
    fbck_instr_loop.addData('fbck_cor_2.stopped', fbck_cor_2.tStopRefresh)
    fbck_instr_loop.addData('fbck_incor_2.started', fbck_incor_2.tStartRefresh)
    fbck_instr_loop.addData('fbck_incor_2.stopped', fbck_incor_2.tStopRefresh)
    fbck_instr_loop.addData('feedback_txt_example.started', feedback_txt_example.tStartRefresh)
    fbck_instr_loop.addData('feedback_txt_example.stopped', feedback_txt_example.tStopRefresh)
    # check responses
    if feedback_instruction.keys in ['', [], None]:  # No response was made
        feedback_instruction.keys = None
    fbck_instr_loop.addData('feedback_instruction.keys',feedback_instruction.keys)
    if feedback_instruction.keys != None:  # we had a response
        fbck_instr_loop.addData('feedback_instruction.rt', feedback_instruction.rt)
    fbck_instr_loop.addData('feedback_instruction.started', feedback_instruction.tStartRefresh)
    fbck_instr_loop.addData('feedback_instruction.stopped', feedback_instruction.tStopRefresh)
    # the Routine "feedback_instr" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
# completed 1 repeats of 'fbck_instr_loop'
...
round(120 - t, ndigits = 1))
        ...
        if exp_block == 'left':
            ...
            bloc_type = trials['Hi']
            targets_left = expect_high_trials['left_stims']
            targets_right = expect_high_trials['right_stims']
            
        elif exp_block == 'low':
            bloc_type = trials['Lo']
            
            targets_left = expect_low_trials['left_stims']
            targets_right = expect_low_trials['right_stims']
        ...
        for thisTrial in trials:
            ...
            # update component parameters for each repeat
            place_left_7.setLineColor(prob_cue_L)
            place_right_7.setLineColor(prob_cue_R)
            # keep track of which components have finished
            blank_postComponents = [post_stim_fix, place_left_7, place_right_7, long_back_R_7, hi_back_R_7, hi_back_L_7, long_back_L_7]
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                # *place_left_7* updates
                if place_left_7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    place_left_7.frameNStart = frameN  # exact frame index
                    place_left_7.tStart = t  # local t and not account for scr refresh
                    place_left_7.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(place_left_7, 'tStartRefresh')  # time at next scr refresh
                    place_left_7.setAutoDraw(True)
                if place_left_7.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > place_left_7.tStartRefresh + .4-frameTolerance:
                        # keep track of stop time/frame for later
                        place_left_7.tStop = t  # not accounting for scr refresh
                        place_left_7.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(place_left_7, 'tStopRefresh')  # time at next scr refresh
                        place_left_7.setAutoDraw(False)
                
                # *place_right_7* updates
                if place_right_7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    place_right_7.frameNStart = frameN  # exact frame index
                    place_right_7.tStart = t  # local t and not account for scr refresh
                    place_right_7.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(place_right_7, 'tStartRefresh')  # time at next scr refresh
                    place_right_7.setAutoDraw(True)
                if place_right_7.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > place_right_7.tStartRefresh + .4-frameTolerance:
                        # keep track of stop time/frame for later
                        place_right_7.tStop = t  # not accounting for scr refresh
                        place_right_7.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(place_right_7, 'tStopRefresh')  # time at next scr refresh
                        place_right_7.setAutoDraw(False)
                
                # *long_back_R_7* updates
                if long_back_R_7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    long_back_R_7.frameNStart = frameN  # exact frame index
                    long_back_R_7.tStart = t  # local t and not account for scr refresh
                    long_back_R_7.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(long_back_R_7, 'tStartRefresh')  # time at next scr refresh
                    long_back_R_7.setAutoDraw(True)
                if long_back_R_7.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > long_back_R_7.tStartRefresh + .4-frameTolerance:
                        # keep track of stop time/frame for later
                        long_back_R_7.tStop = t  # not accounting for scr refresh
                        long_back_R_7.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(long_back_R_7, 'tStopRefresh')  # time at next scr refresh
                        long_back_R_7.setAutoDraw(False)
                
                # *hi_back_R_7* updates
                if hi_back_R_7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    hi_back_R_7.frameNStart = frameN  # exact frame index
                    hi_back_R_7.tStart = t  # local t and not account for scr refresh
                    hi_back_R_7.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(hi_back_R_7, 'tStartRefresh')  # time at next scr refresh
                    hi_back_R_7.setAutoDraw(True)
                if hi_back_R_7.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > hi_back_R_7.tStartRefresh + .4-frameTolerance:
                        # keep track of stop time/frame for later
                        hi_back_R_7.tStop = t  # not accounting for scr refresh
                        hi_back_R_7.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(hi_back_R_7, 'tStopRefresh')  # time at next scr refresh
                        hi_back_R_7.setAutoDraw(False)
                
                # *hi_back_L_7* updates
                if hi_back_L_7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    hi_back_L_7.frameNStart = frameN  # exact frame index
                    hi_back_L_7.tStart = t  # local t and not account for scr refresh
                    hi_back_L_7.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(hi_back_L_7, 'tStartRefresh')  # time at next scr refresh
                    hi_back_L_7.setAutoDraw(True)
                if hi_back_L_7.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > hi_back_L_7.tStartRefresh + .4-frameTolerance:
                        # keep track of stop time/frame for later
                        hi_back_L_7.tStop = t  # not accounting for scr refresh
                        hi_back_L_7.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(hi_back_L_7, 'tStopRefresh')  # time at next scr refresh
                        hi_back_L_7.setAutoDraw(False)
                
                # *long_back_L_7* updates
                if long_back_L_7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    long_back_L_7.frameNStart = frameN  # exact frame index
                    long_back_L_7.tStart = t  # local t and not account for scr refresh
                    long_back_L_7.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(long_back_L_7, 'tStartRefresh')  # time at next scr refresh
                    long_back_L_7.setAutoDraw(True)
                if long_back_L_7.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > long_back_L_7.tStartRefresh + .4-frameTolerance:
                        # keep track of stop time/frame for later
                        long_back_L_7.tStop = t  # not accounting for scr refresh
                        long_back_L_7.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(long_back_L_7, 'tStopRefresh')  # time at next scr refresh
                        long_back_L_7.setAutoDraw(False)
            ...
            trials.addData('place_left_7.started', place_left_7.tStartRefresh)
            trials.addData('place_left_7.stopped', place_left_7.tStopRefresh)
            trials.addData('place_right_7.started', place_right_7.tStartRefresh)
            trials.addData('place_right_7.stopped', place_right_7.tStopRefresh)
            trials.addData('long_back_R_7.started', long_back_R_7.tStartRefresh)
            trials.addData('long_back_R_7.stopped', long_back_R_7.tStopRefresh)
            trials.addData('hi_back_R_7.started', hi_back_R_7.tStartRefresh)
            trials.addData('hi_back_R_7.stopped', hi_back_R_7.tStopRefresh)
            trials.addData('hi_back_L_7.started', hi_back_L_7.tStartRefresh)
            trials.addData('hi_back_L_7.stopped', hi_back_L_7.tStopRefresh)
            trials.addData('long_back_L_7.started', long_back_L_7.tStartRefresh)
            trials.addData('long_back_L_7.stopped', long_back_L_7.tStopRefresh)
            ...
            place_left_8.setLineColor(prob_cue_L)
            place_right_8.setLineColor(prob_cue_R)
            # keep track of which components have finished
            q_catComponents = [q_category, cat_resp, probe_cue_cat, place_left_8, place_right_8, long_back_R_8, hi_back_R_8, hi_back_L_8, long_back_L_8]
            for thisComponent in q_catComponents:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                # *place_left_8* updates
                if place_left_8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    place_left_8.frameNStart = frameN  # exact frame index
                    place_left_8.tStart = t  # local t and not account for scr refresh
                    place_left_8.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(place_left_8, 'tStartRefresh')  # time at next scr refresh
                    place_left_8.setAutoDraw(True)
                if place_left_8.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > place_left_8.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        place_left_8.tStop = t  # not accounting for scr refresh
                        place_left_8.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(place_left_8, 'tStopRefresh')  # time at next scr refresh
                        place_left_8.setAutoDraw(False)
                
                # *place_right_8* updates
                if place_right_8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    place_right_8.frameNStart = frameN  # exact frame index
                    place_right_8.tStart = t  # local t and not account for scr refresh
                    place_right_8.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(place_right_8, 'tStartRefresh')  # time at next scr refresh
                    place_right_8.setAutoDraw(True)
                if place_right_8.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > place_right_8.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        place_right_8.tStop = t  # not accounting for scr refresh
                        place_right_8.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(place_right_8, 'tStopRefresh')  # time at next scr refresh
                        place_right_8.setAutoDraw(False)
                
                # *long_back_R_8* updates
                if long_back_R_8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    long_back_R_8.frameNStart = frameN  # exact frame index
                    long_back_R_8.tStart = t  # local t and not account for scr refresh
                    long_back_R_8.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(long_back_R_8, 'tStartRefresh')  # time at next scr refresh
                    long_back_R_8.setAutoDraw(True)
                if long_back_R_8.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > long_back_R_8.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        long_back_R_8.tStop = t  # not accounting for scr refresh
                        long_back_R_8.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(long_back_R_8, 'tStopRefresh')  # time at next scr refresh
                        long_back_R_8.setAutoDraw(False)
                
                # *hi_back_R_8* updates
                if hi_back_R_8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    hi_back_R_8.frameNStart = frameN  # exact frame index
                    hi_back_R_8.tStart = t  # local t and not account for scr refresh
                    hi_back_R_8.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(hi_back_R_8, 'tStartRefresh')  # time at next scr refresh
                    hi_back_R_8.setAutoDraw(True)
                if hi_back_R_8.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > hi_back_R_8.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        hi_back_R_8.tStop = t  # not accounting for scr refresh
                        hi_back_R_8.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(hi_back_R_8, 'tStopRefresh')  # time at next scr refresh
                        hi_back_R_8.setAutoDraw(False)
                
                # *hi_back_L_8* updates
                if hi_back_L_8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    hi_back_L_8.frameNStart = frameN  # exact frame index
                    hi_back_L_8.tStart = t  # local t and not account for scr refresh
                    hi_back_L_8.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(hi_back_L_8, 'tStartRefresh')  # time at next scr refresh
                    hi_back_L_8.setAutoDraw(True)
                if hi_back_L_8.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > hi_back_L_8.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        hi_back_L_8.tStop = t  # not accounting for scr refresh
                        hi_back_L_8.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(hi_back_L_8, 'tStopRefresh')  # time at next scr refresh
                        hi_back_L_8.setAutoDraw(False)
                
                # *long_back_L_8* updates
                if long_back_L_8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    long_back_L_8.frameNStart = frameN  # exact frame index
                    long_back_L_8.tStart = t  # local t and not account for scr refresh
                    long_back_L_8.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(long_back_L_8, 'tStartRefresh')  # time at next scr refresh
                    long_back_L_8.setAutoDraw(True)
                if long_back_L_8.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > long_back_L_8.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        long_back_L_8.tStop = t  # not accounting for scr refresh
                        long_back_L_8.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(long_back_L_8, 'tStopRefresh')  # time at next scr refresh
                        long_back_L_8.setAutoDraw(False)
            ...
            trials.addData('place_left_8.started', place_left_8.tStartRefresh)
            trials.addData('place_left_8.stopped', place_left_8.tStopRefresh)
            trials.addData('place_right_8.started', place_right_8.tStartRefresh)
            trials.addData('place_right_8.stopped', place_right_8.tStopRefresh)
            trials.addData('long_back_R_8.started', long_back_R_8.tStartRefresh)
            trials.addData('long_back_R_8.stopped', long_back_R_8.tStopRefresh)
            trials.addData('hi_back_R_8.started', hi_back_R_8.tStartRefresh)
            trials.addData('hi_back_R_8.stopped', hi_back_R_8.tStopRefresh)
            trials.addData('hi_back_L_8.started', hi_back_L_8.tStartRefresh)
            trials.addData('hi_back_L_8.stopped', hi_back_L_8.tStopRefresh)
            trials.addData('long_back_L_8.started', long_back_L_8.tStartRefresh)
            trials.addData('long_back_L_8.stopped', long_back_L_8.tStopRefresh)
            ...
            place_left_9.setLineColor(prob_cue_L)
            place_right_9.setLineColor(prob_cue_R)
            # keep track of which components have finished
            q_recComponents = [q_recognition, rec_resp, probe_cue_rec, place_left_9, place_right_9, long_back_R_9, hi_back_R_9, hi_back_L_9, long_back_L_9]
            for thisComponent in q_recComponents:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                # *place_left_9* updates
                if place_left_9.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    place_left_9.frameNStart = frameN  # exact frame index
                    place_left_9.tStart = t  # local t and not account for scr refresh
                    place_left_9.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(place_left_9, 'tStartRefresh')  # time at next scr refresh
                    place_left_9.setAutoDraw(True)
                if place_left_9.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > place_left_9.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        place_left_9.tStop = t  # not accounting for scr refresh
                        place_left_9.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(place_left_9, 'tStopRefresh')  # time at next scr refresh
                        place_left_9.setAutoDraw(False)
                
                # *place_right_9* updates
                if place_right_9.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    place_right_9.frameNStart = frameN  # exact frame index
                    place_right_9.tStart = t  # local t and not account for scr refresh
                    place_right_9.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(place_right_9, 'tStartRefresh')  # time at next scr refresh
                    place_right_9.setAutoDraw(True)
                if place_right_9.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > place_right_9.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        place_right_9.tStop = t  # not accounting for scr refresh
                        place_right_9.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(place_right_9, 'tStopRefresh')  # time at next scr refresh
                        place_right_9.setAutoDraw(False)
                
                # *long_back_R_9* updates
                if long_back_R_9.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    long_back_R_9.frameNStart = frameN  # exact frame index
                    long_back_R_9.tStart = t  # local t and not account for scr refresh
                    long_back_R_9.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(long_back_R_9, 'tStartRefresh')  # time at next scr refresh
                    long_back_R_9.setAutoDraw(True)
                if long_back_R_9.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > long_back_R_9.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        long_back_R_9.tStop = t  # not accounting for scr refresh
                        long_back_R_9.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(long_back_R_9, 'tStopRefresh')  # time at next scr refresh
                        long_back_R_9.setAutoDraw(False)
                
                # *hi_back_R_9* updates
                if hi_back_R_9.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    hi_back_R_9.frameNStart = frameN  # exact frame index
                    hi_back_R_9.tStart = t  # local t and not account for scr refresh
                    hi_back_R_9.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(hi_back_R_9, 'tStartRefresh')  # time at next scr refresh
                    hi_back_R_9.setAutoDraw(True)
                if hi_back_R_9.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > hi_back_R_9.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        hi_back_R_9.tStop = t  # not accounting for scr refresh
                        hi_back_R_9.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(hi_back_R_9, 'tStopRefresh')  # time at next scr refresh
                        hi_back_R_9.setAutoDraw(False)
                
                # *hi_back_L_9* updates
                if hi_back_L_9.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    hi_back_L_9.frameNStart = frameN  # exact frame index
                    hi_back_L_9.tStart = t  # local t and not account for scr refresh
                    hi_back_L_9.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(hi_back_L_9, 'tStartRefresh')  # time at next scr refresh
                    hi_back_L_9.setAutoDraw(True)
                if hi_back_L_9.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > hi_back_L_9.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        hi_back_L_9.tStop = t  # not accounting for scr refresh
                        hi_back_L_9.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(hi_back_L_9, 'tStopRefresh')  # time at next scr refresh
                        hi_back_L_9.setAutoDraw(False)
                
                # *long_back_L_9* updates
                if long_back_L_9.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    long_back_L_9.frameNStart = frameN  # exact frame index
                    long_back_L_9.tStart = t  # local t and not account for scr refresh
                    long_back_L_9.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(long_back_L_9, 'tStartRefresh')  # time at next scr refresh
                    long_back_L_9.setAutoDraw(True)
                if long_back_L_9.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > long_back_L_9.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        long_back_L_9.tStop = t  # not accounting for scr refresh
                        long_back_L_9.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(long_back_L_9, 'tStopRefresh')  # time at next scr refresh
                        long_back_L_9.setAutoDraw(False)
            ...
            trials.addData('place_left_9.started', place_left_9.tStartRefresh)
            trials.addData('place_left_9.stopped', place_left_9.tStopRefresh)
            trials.addData('place_right_9.started', place_right_9.tStartRefresh)
            trials.addData('place_right_9.stopped', place_right_9.tStopRefresh)
            trials.addData('long_back_R_9.started', long_back_R_9.tStartRefresh)
            trials.addData('long_back_R_9.stopped', long_back_R_9.tStopRefresh)
            trials.addData('hi_back_R_9.started', hi_back_R_9.tStartRefresh)
            trials.addData('hi_back_R_9.stopped', hi_back_R_9.tStopRefresh)
            trials.addData('hi_back_L_9.started', hi_back_L_9.tStartRefresh)
            trials.addData('hi_back_L_9.stopped', hi_back_L_9.tStopRefresh)
            trials.addData('long_back_L_9.started', long_back_L_9.tStartRefresh)
            trials.addData('long_back_L_9.stopped', long_back_L_9.tStopRefresh)
            ...
            place_left_10.setLineColor(prob_cue_L)
            place_right_10.setLineColor(prob_cue_R)
            # keep track of which components have finished
            q_confComponents = [q_confidence, conf_resp, probe_cue_cat_2, place_left_10, place_right_10, long_back_R_10, hi_back_R_10, hi_back_L_10, long_back_L_10]
            for thisComponent in q_confComponents:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                # *place_left_10* updates
                if place_left_10.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    place_left_10.frameNStart = frameN  # exact frame index
                    place_left_10.tStart = t  # local t and not account for scr refresh
                    place_left_10.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(place_left_10, 'tStartRefresh')  # time at next scr refresh
                    place_left_10.setAutoDraw(True)
                if place_left_10.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > place_left_10.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        place_left_10.tStop = t  # not accounting for scr refresh
                        place_left_10.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(place_left_10, 'tStopRefresh')  # time at next scr refresh
                        place_left_10.setAutoDraw(False)
                
                # *place_right_10* updates
                if place_right_10.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    place_right_10.frameNStart = frameN  # exact frame index
                    place_right_10.tStart = t  # local t and not account for scr refresh
                    place_right_10.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(place_right_10, 'tStartRefresh')  # time at next scr refresh
                    place_right_10.setAutoDraw(True)
                if place_right_10.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > place_right_10.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        place_right_10.tStop = t  # not accounting for scr refresh
                        place_right_10.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(place_right_10, 'tStopRefresh')  # time at next scr refresh
                        place_right_10.setAutoDraw(False)
                
                # *long_back_R_10* updates
                if long_back_R_10.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    long_back_R_10.frameNStart = frameN  # exact frame index
                    long_back_R_10.tStart = t  # local t and not account for scr refresh
                    long_back_R_10.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(long_back_R_10, 'tStartRefresh')  # time at next scr refresh
                    long_back_R_10.setAutoDraw(True)
                if long_back_R_10.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > long_back_R_10.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        long_back_R_10.tStop = t  # not accounting for scr refresh
                        long_back_R_10.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(long_back_R_10, 'tStopRefresh')  # time at next scr refresh
                        long_back_R_10.setAutoDraw(False)
                
                # *hi_back_R_10* updates
                if hi_back_R_10.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    hi_back_R_10.frameNStart = frameN  # exact frame index
                    hi_back_R_10.tStart = t  # local t and not account for scr refresh
                    hi_back_R_10.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(hi_back_R_10, 'tStartRefresh')  # time at next scr refresh
                    hi_back_R_10.setAutoDraw(True)
                if hi_back_R_10.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > hi_back_R_10.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        hi_back_R_10.tStop = t  # not accounting for scr refresh
                        hi_back_R_10.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(hi_back_R_10, 'tStopRefresh')  # time at next scr refresh
                        hi_back_R_10.setAutoDraw(False)
                
                # *hi_back_L_10* updates
                if hi_back_L_10.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    hi_back_L_10.frameNStart = frameN  # exact frame index
                    hi_back_L_10.tStart = t  # local t and not account for scr refresh
                    hi_back_L_10.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(hi_back_L_10, 'tStartRefresh')  # time at next scr refresh
                    hi_back_L_10.setAutoDraw(True)
                if hi_back_L_10.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > hi_back_L_10.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        hi_back_L_10.tStop = t  # not accounting for scr refresh
                        hi_back_L_10.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(hi_back_L_10, 'tStopRefresh')  # time at next scr refresh
                        hi_back_L_10.setAutoDraw(False)
                
                # *long_back_L_10* updates
                if long_back_L_10.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    long_back_L_10.frameNStart = frameN  # exact frame index
                    long_back_L_10.tStart = t  # local t and not account for scr refresh
                    long_back_L_10.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(long_back_L_10, 'tStartRefresh')  # time at next scr refresh
                    long_back_L_10.setAutoDraw(True)
                if long_back_L_10.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > long_back_L_10.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        long_back_L_10.tStop = t  # not accounting for scr refresh
                        long_back_L_10.frameNStop = frameN  # exact frame index
                        win.timeOnFlip(long_back_L_10, 'tStopRefresh')  # time at next scr refresh
                        long_back_L_10.setAutoDraw(False)
            ...
            trials.addData('place_left_10.started', place_left_10.tStartRefresh)
            trials.addData('place_left_10.stopped', place_left_10.tStopRefresh)
            trials.addData('place_right_10.started', place_right_10.tStartRefresh)
            trials.addData('place_right_10.stopped', place_right_10.tStopRefresh)
            trials.addData('long_back_R_10.started', long_back_R_10.tStartRefresh)
            trials.addData('long_back_R_10.stopped', long_back_R_10.tStopRefresh)
            trials.addData('hi_back_R_10.started', hi_back_R_10.tStartRefresh)
            trials.addData('hi_back_R_10.stopped', hi_back_R_10.tStopRefresh)
            trials.addData('hi_back_L_10.started', hi_back_L_10.tStartRefresh)
            trials.addData('hi_back_L_10.stopped', hi_back_L_10.tStopRefresh)
            trials.addData('long_back_L_10.started', long_back_L_10.tStartRefresh)
            trials.addData('long_back_L_10.stopped', long_back_L_10.tStopRefresh)
