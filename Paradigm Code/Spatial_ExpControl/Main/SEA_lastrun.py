...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/brandonchen93/EASTO/Paradigm/Behavior/Spatial_ExpControl/Main/SEA_lastrun.py',
...
round(120 - t, ndigits = 1))
    ...
    for thisTrial in trials:
        ...
        # update component parameters for each repeat
        place_left_7.setLineColor(prob_left)
        place_right_7.setLineColor(prob_right)
        ...
        place_left_8.setLineColor(prob_left)
        place_right_8.setLineColor(prob_right)
        # keep track of which components have finished
        ...
        rec_resp.rt = []
        _rec_resp_allKeys = []
        probe_cue_rec.setImage(probe_cue_img)
        place_left_9.setLineColor(prob_left)
        place_right_9.setLineColor(prob_right)
        # keep track of which components have finished
        ...
        place_left_10.setLineColor(prob_left)
        place_right_10.setLineColor(prob_right)
        # keep track of which components have finished
