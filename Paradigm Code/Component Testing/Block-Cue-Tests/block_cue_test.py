...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/brandonchen93/Downloads/block_cue_test.py',
...
left_img = np.random.choice(real_imgs)
right_img = np.random.choice(scram_imgs)
