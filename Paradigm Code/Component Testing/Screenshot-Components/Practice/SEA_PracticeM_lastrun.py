...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/brandonchen93/EASTO/Paradigm/Component Testing/Screenshot_Components/Practice/SEA_PracticeM_lastrun.py',
...
expect_left_trials, expect_right_trials, expect_neutral_trials = ea.generate_stim(real_imgs, scram_imgs, 'practice_cond.xlsx', [1/4, 1/4], 'Spatial')
