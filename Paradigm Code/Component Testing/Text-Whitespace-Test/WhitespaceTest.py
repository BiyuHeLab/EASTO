...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/brandonchen93/Downloads/Attention-Expectation/Object/WhitespaceTest.py',
...
rec_question  = ('Meaningful visual experience: \n\n\n\n\n '
            '{Y:^10} {N:^12}''\n\n\n '
            '{b2:^15} {b3:^15}'.format(Y = 'Yes',
                                               N = 'No',
                                               b2 = '2',
                                               b3 = '3'))
...
for thisTrial in trials:
    ...
    if probe_cue_txt == 'F':
        ...
        cat_question = (
                    'Image Category:\n\n\n\n\n'
                    '{cats1:' '^15} {cats2:' '^15} {cats3:' '^15}\n\n\n'
                    '{b1:' '^15} {b2:' '^15} {b3:' '^15}'.format(cats1 = cats[0], 
                                                               cats2 = cats[1], 
                                                               cats3 = cats[2], b1 = '1',b2 = '2',b3 = '3', 
                                                                ))
    ...
    cat_question = (
                    'Image Category:\n\n\n\n\n'
                    '{cats1:' '^15} {cats2:' '^15} \n\n\n'
                    '{b1:' '^15} {b2:' '^15}'.format(cats1 = cats_gen[0], 
                                                               cats2 = cats_gen[1], 
                                                               b1 = '2',b2 = '3' 
                                                                ))
